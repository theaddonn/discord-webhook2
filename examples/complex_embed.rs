        ...
        .send(&Message::new(|message| {
            message.embed(|embed| {
                embed
                    ...
                    .footer(|footer| footer.text("Footer text"))
                    .author(|author| author.name("Author name").url("https://example.com"))
                    .field(|field| field.name("Field name 1").value("Value 1"))
                    .field(|field| field.name("Field name 2").inline(true))
